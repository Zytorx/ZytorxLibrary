...
public class FieldCollector {
    ...
    public static <T extends Annotation> Stream<Pair<Object, T>> getFieldsWithAnnotation(Class<T> annotation, Class<?>... classes) {
    ...
    public static <T extends RegistryCollection> Stream<T> getCollections(Class<T> returnType, Class<?>... classes) {
    ...
    public static Stream<RegistryCollection> getCollectionsForRecipe(Class<?>... classes) {
